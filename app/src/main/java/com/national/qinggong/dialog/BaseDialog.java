...
public abstract class BaseDialog<D extends BaseDialog> extends Dialog implements View.OnClickListener {
    ...
    protected void initDialog() {
        ...
        BaseDialogOnClickHelper.getInstance().onBindClickListener(rootView, this);
        onCreateData();
    }
     ...
     *设置控件是否可见
     */
    public void setViewVisiable(@NonNull View view, int visiable) {
        if (view != null) {
     ...
     *设置控件是否可见
     */
    public void setViewVisiable(@IdRes int id, int visiable) {
        View view = findView(id);
        if (view != null) {
            view.setVisibility(visiable);
        }
    ...
    public void onDialogClickListener(@IdRes int id) {
        if (onDialogClickListener != null) {
            onDialogClickListener.onDialogClick((D) this, id);
        }
    }
